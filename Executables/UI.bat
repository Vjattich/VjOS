...
powershell -command "&{$p='HKU:SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\StuckRects3';$v=(Get-ItemProperty -Path $p).Settings; $v[12]=1; &Set-ItemProperty -Path $p -Name Settings -Value $v;}"
